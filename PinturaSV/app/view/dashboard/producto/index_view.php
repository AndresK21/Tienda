					...
					<?php
						foreach($data as $row){
							...
							<tr>
								...
								<td><i class='material-icons'>".($row['id_estado']?"visibility":"visibility_off")."</i></td>
								<td>

									<a class='waves-effect waves-light espacio tooltipped' data-position='right' data-delay='50' data-tooltip='Editar producto' href='update.php?id=$row[id_producto]'><i class='material-icons blue-text text-darken-3 prefix'>edit</i></a>
									<a class='waves-effect waves-light espacio tooltipped' data-position='right' data-delay='50' data-tooltip='Eliminar producto' href='delete.php?id=$row[id_producto]'><i class='material-icons red-text text-darken-3 prefix'>delete</i></a></td>
								</td>
							</tr>
							");
						}
