			...
			<div class="col s12 m6 l6 offset-l3 offset-m3">
				<div class="card grey lighten-4">
					<div class="card-content">
						...
						<div class="row">
							...
							<div class="input-field col s12">
								<input id="usuario" type="text" class="validate" value='<?php print($object->getUsuario()) ?>' required />
								<label class="black-text" for="usuario">Nombre de usuario</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
								<input id="contrasena" type="password" class="validate" '<?php print($object->getContrasena()) ?>' required />
					...
					<div class="right-align blue-grey-text">
						<button type='submit' name='iniciar' class='btn waves-effect'>Iniciar sesi&oacute;n</button>
					</div>
				</div>
			</div>
		</div>
