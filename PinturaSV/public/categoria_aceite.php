...
<html>
    ...
    <body>
        ...
        <li><a href="../public/categoria_aceite.html">Aceite</a></li>
        <li class="divider"></li>
        <li><a href="../public/categoria_agua.html">Agua</a></li>
        </ul>
        ...
        <nav>
            ...
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="iniciar_sesion.html">Iniciar Sesi&oacute;n</a></li>
            ...
            <ul class="side-nav" id="mobile-demo">
                ...
                <li><a href="iniciar_sesion.html">Contactanos</a></li>
        ...
        <div class="container"> 
            <!--CATEGORIA -->
            <h4 class="left-align">Pintura de Aceite
            </h4>
            <!-- BUSQUEDA -->
            <div class="row">
                    <div class="col s8">
                                    ...
                                    <div class="card horizontal">
                                        ...
                                        <div class="card-stacked">
                                            ...
                                            <div class="card-action">
                                                ...
                                                <a class="green-text" href="../public/pagar.html">Relizar Pago</a> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
